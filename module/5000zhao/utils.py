...
def genImage(word_a="5000兆円", word_b="欲しい!", default_width=1500, height=500,
    ...
    alpha = (0, 0, 0, 0)
    leftmargin = 50
    font_upper = ImageFont.truetype("./resource/fonts/STKAITI.ttf", _round(height/3))
    font_downer = ImageFont.truetype("./resource/fonts/STKAITI.ttf", _round(height/3))
    ...
    previmg.save("./data/5000zhao/test1.png")
